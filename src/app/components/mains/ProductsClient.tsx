      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mt-12 pt-8 border-t border-amber-200">
        ...
        <div className="flex items-center gap-3">
          ...
          <select
            ...
            className="bg-white border border-amber-200 rounded-lg px-3 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-orange-500"
          >
          ...
          <div className="mb-6 flex flex-col sm:flex-row sm:items-center gap-4">
            <div className="flex items-center gap-3">
              <p className="text-amber-700">
                Showing {Math.min(totalItems, 1)}-{Math.min(endIndex, totalItems)} of {totalItems} products
